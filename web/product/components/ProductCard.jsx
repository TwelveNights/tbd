    ...
    render() {
        return (
            <div className="card mt-5">
                ...
                <h5 className="mb-0">
                    <a data-parent="#accordion" href={ this.props.product.url } target="_blank" rel="noopener noreferrer" aria-expanded="true" aria-controls={ this.props.product._id }>
                ...
                <div className="collapse show" role="tabpanel" aria-labelledby={ this.props.product.name }>
